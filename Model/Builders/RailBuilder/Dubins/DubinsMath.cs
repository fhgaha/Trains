...
//Careful! This whole xz, xy unity-godot thing can be dangerous.
		...
		public static Vector3 GetLeftCircleCenterPos(Vector3 carPos, float heading)
		{
			...
			leftCirclePos.x = carPos.x + turningRadius * Mathf.Sin(heading - (Mathf.Pi / 2f));
			leftCirclePos.z = carPos.z + turningRadius * Mathf.Cos(heading - (Mathf.Pi / 2f));
