...
//There is no "Script 1 - Move and Rotate the target car" - this script is Unity specific.
//Script 2 - Debug the Dubins paths
//The script is the main script that will control everything else and is the only script you have to attach 
//to the gameobject "Dubins Paths".
